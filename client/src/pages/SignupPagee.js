...
export const SignUp = () => {
    ...
    return (
        <div className="flex justify-center ">
            <div className="shadow-gray-200 mt-60 bg-gray-200 shadow-md border-black px-4 sm:px-16 py-4 rounded-xl">
                ...
                <form >
                    ...
                    <div>
                        <input className={inputStyle} type="text" placeholder="UserName..." name="username"  />
                    </div>
                    ...
                    <div>
                    <span className="flex">
                        <input className={inputStyle} type={ vis2 } placeholder="Confirm Password..." name="password"  />
